...
export default {
  ...
  mounted() {
    ...
    const pullUrl = 'http://47.117.139.250:8080/live?port=1935&app=myapp&stream=' + meeting.streamId
    console.log(pullUrl)
    ...
    if (flvjs.isSupported()) {
      ...
      var flvPlayer = flvjs.createPlayer({
        type: 'flv',
        // url: 'http://47.117.139.250:8080/live?port=1935&app=myapp&stream=live'
        url: pullUrl
      });
